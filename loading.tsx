    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          display: 'flex', flexDirection: 'column',
          alignItems: 'center', justifyContent: 'center', gap: 5, zIndex: 2,
        }}>
          <div style={{
            background: '#D9782D', color: '#fff', fontWeight: 800,
            fontSize: 10, padding: '3px 10px', borderRadius: 4, letterSpacing: .5,
          }}>AUTOBACS</div>
          <div style={{ color: 'rgba(255,255,255,.2)', fontSize: 9, letterSpacing: 2 }}>FRANCE</div>
        </div>
      </div>
